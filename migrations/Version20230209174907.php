 ...
 */
final class Version20230209174907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT NOT NULL, music_group_id INT DEFAULT NULL, title VARCHAR(50) NOT NULL, description TEXT NOT NULL, lieu VARCHAR(100) DEFAULT NULL, public BOOLEAN NOT NULL, event_start TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, event_end TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, background_color VARCHAR(7) NOT NULL, border_color VARCHAR(7) NOT NULL, text_color VARCHAR(7) NOT NULL, PRIMARY KEY(id))');
