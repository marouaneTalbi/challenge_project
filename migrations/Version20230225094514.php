 ...
 */
final class Version20230225094514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE album (id INT NOT NULL, music_group_id INT NOT NULL, name VARCHAR(50) NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
